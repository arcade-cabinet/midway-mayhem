 ...
 *
 * Mobile-first input mapping (REQUIRED — no keyboard-only tricks):
 *   left   → swipe left on screen while airborne
 *   right  → swipe right on screen while airborne
 *   up     → swipe up on screen while airborne
