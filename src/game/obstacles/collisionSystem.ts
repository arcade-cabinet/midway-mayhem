/**
 * @module game/obstacles/collisionSystem
 *
 * Sphere-based collision detection on the XZ plane. Pure function — no
 * side-effects, no ECS coupling. Called from useObstacleFrame each tick.
 */
