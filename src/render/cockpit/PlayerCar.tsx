/**
 * PlayerCar — world-space clown-car body rendered at the player's current
 * track position. Used for external cameras (replay, game-over pan-out).
 * The in-game first-person view uses Cockpit instead.
 *
 * Cockpit pillars, polka-dot hood, dashboard, steering wheel, chrome gauges,
 * hood ornament, mirror with fuzzy dice.
 *
 * Depends on @/game/gameState (useGameStore) — wired by the game-state agent.
 * Until that lands, the car sits stationary at track origin.
 */
