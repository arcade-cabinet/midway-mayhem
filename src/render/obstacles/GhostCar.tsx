/**
 * @module render/obstacles/GhostCar
 *
 ...
 *
 * Ported from reference/src/obstacles/GhostCar.tsx. Replaces the v2 stub
 * at src/render/GhostCar.tsx which used the koota ghost system. This version
 * uses the SQLite-backed persistence layer and the full daily-route guard.
 */
