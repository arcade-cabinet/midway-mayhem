...
//
// These objects exist purely to preserve the legacy uppercase-field API
// (TRACK.LANE_WIDTH, HONK.SCARE_RADIUS_M, STEER.MAX_LATERAL_MPS) that
// ~25 call sites consume. The source of truth is src/config/tunables.json
// under the `track`, `honk`, and `steer` blocks — edit the JSON, not
// these bindings.
